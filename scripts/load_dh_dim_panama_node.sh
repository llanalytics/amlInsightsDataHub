...
TABLE_NAME="dh_dim_panama_node"

usage() {
  cat <<'EOF'
Usage:
  ./scripts/load_dh_dim_panama_node.sh [--full] [--allow-existing]

Behavior:
  - By default, uses data/sample/dh_dim_panama_node_sample_small.csv when present.
  - Falls back to data/sample/dh_dim_panama_node_sample.csv.
